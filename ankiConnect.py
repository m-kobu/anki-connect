...
note = {"command":"o", "action":"opens a blank line below"}

#result_create_deck = invoke("createDeck", deck="Programming::vim")
result_list_of_decks = invoke("deckNames")
result_add_note = invoke("addNotes", notes=[{"deckName":"Programming::vim", "modelName":"Programming::vim", "fields": note, "tags":[]}])
